<script lang="ts">
 ...
 export let randomDisable: boolean = false;
...
<Button
 classList="btn btn-outline btn-success join-item btn-sm"
...
<Button classList="btn btn-outline btn-error join-item btn-sm" on:click={clear}>
 Clear
 <svg
  xmlns="http://www.w3.org/2000/svg"
  width="16"
...
<!-- <button class="btn btn-outline btn-error join-item" on:click={rehash}
 >Rehash <svg
  xmlns="http://www.w3.org/2000/svg"
  width="16"
  height="16"
